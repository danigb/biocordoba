ActionController::Routing::Routes.draw do |map|
  ...
  map.new_admin '/admin/usuarios/nuevo/administrador', :controller => 'admin/users', :action => 'new_admin_extenda'
  map.register_admin '/admin/usuarios/registro/administrador', :controller => 'admin/users', :action => 'create_admin_extenda'
